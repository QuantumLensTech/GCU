...
Le détail de ce qui est démontré, contraint ou encore ouvert est documenté dans le corpus complet (non public à ce stade). Deux documents publics :

- [`docs/invariants.md`](docs/invariants.md) — le noyau d'invariants exécutables, ce qui est gelé et pourquoi.
- [`docs/champs.md`](docs/champs.md) — la structure à 8 champs et sa hiérarchie génératrice.
